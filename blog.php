...
<script src="script.js"></script>
  ...
  <div class="text" >Ultimas novedades</div>

      <div class="menu-container">
        <div class="menu-section">
          <img class="bordercodeimg" src="https://i.blogs.es/c47f89/photo-1675271591211-126ad94e495d/1200_800.jpeg" loading="lazy">
          <h2>El reto más dificil de OpenAI</h2>
          <a href="bgopenai.php"><button class="redes">Leer</button></a>
        </div>
        <div class="menu-section">
          <img class="bordercodeimg" src="https://i.blogs.es/52d4de/captura-de-pantalla-2023-10-20-a-las-10.41.11/1366_2000.jpeg"  loading="lazy">
          <h2>Blackbox: qué es y que ofrece esta herramienta</h2>
          <a href="bgblackblox.php"><button class="sup">Leer</button></a>
        </div>
     
        <div class="menu-section">
          <img class="bordercodeimg" src="https://i.blogs.es/c1bf41/marijus-briedis-nord-security/1200_800.jpeg"  loading="lazy">
          <h2>Es importante saber cómo las empresas usan nuestros datos para cambiar nuestro comportamiento</h2>
          <a href="bgsecurity.php"><button class="dw">Leer</button></a>
        </div>
